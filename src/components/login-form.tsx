      ...
      <Card className="overflow-hidden">
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <Form {...form}>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                <h1 className="text-2xl font-bold">Bienvedido</h1>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="email" placeholder="joedoe@example.com" {...field} />
                    </FormControl>
                    {/* <FormDescription>
          ...
          <div className="relative hidden bg-muted md:block">
            <img
              src="https://images.unsplash.com/photo-1548704686-f0a484c1bd67?q=80&w=1827&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Image"
